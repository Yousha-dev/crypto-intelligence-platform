...
schema_view = get_schema_view(
    openapi.Info(
        title="Crypto Insight Engine API",
        default_version="v1",
        description="API documentation for Crypto Insight Engine backend.",
...
urlpatterns = api_urlpatterns + [
    ...
    path('', RedirectView.as_view(url='/swagger/', permanent=False)),  # Optional: redirect root to swagger
]
