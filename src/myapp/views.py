...
custom_headers = [
    openapi.Parameter(
        'X-User-ID', openapi.IN_HEADER, description="User ID extracted from token", type=openapi.TYPE_STRING
    ),
    openapi.Parameter(
        'X-Role', openapi.IN_HEADER, description="Role extracted from token", type=openapi.TYPE_STRING
    ),
]
