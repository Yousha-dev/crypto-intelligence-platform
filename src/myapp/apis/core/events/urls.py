...
urlpatterns = [
    ...
    path('auto-send-action-email-event', AutoSendActionEmailEventAPI.as_view(), name='auto_send_action_email_event'),
    path('auto-send-reminder-email-event', AutoSendReminderEmailEventAPI.as_view(), name='auto_send_reminder_email_event'),
]
